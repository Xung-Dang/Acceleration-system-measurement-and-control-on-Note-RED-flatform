...
#define mqtt_server "projectmain.cloud.shiftr.io" // Thay bằng thông tin của bạn
...
//Giữ nguyên nếu bạn tạo topic tên là demo
//#define mqtt_topic_sub "mm"
//#define mqtt_topic_sub1 "DO_AN/XUNG/SWITCH4"
//#define mqtt_topic_sub2 "DO_AN/XUNG/RUNG/X"
//#define mqtt_topic_sub3 "DO_AN/XUNG/RUNG/Y"
//#define mqtt_topic_sub4 "DO_AN/XUNG/RUNG/Z"
//#define mqtt_topic_sub5 "DO_AN/XUNG/SWITCH3"
//#define mqtt_topic_sub6 "DO_AN/XUNG/CANHBAO"


#define mqtt_user "projectmain"    //Giữ nguyên nếu bạn tạo user là esp8266 và pass là 123456
...
void loop() {
//  biengoc=random(1,50);
//  bienaccx=random(-3,60);
//  bienaccy=random(-3.2,10.3);
//  bienaccz=random(-3.6,15.6);
 Readuart();
...
//  
  ...
  ///var biencanhbao = msg.payload;
//if(biencanhbao=="0")
//msg.payload="Trạng thái chưa chuyển chế độ";
//if(biencanhbao=="1")
//msg.payload="Trạng thái không an toàn của đô rung";
//if(biencanhbao=="2")
//msg.payload="Trạng thái an toàn của đô rung";
//if(biencanhbao=="3")
//msg.payload="Trạng thái không an toàn của gia tốc";
//if(biencanhbao=="4")
//msg.payload="Trạng thái an toàn của gia tốc";
//return msg;
  }
...
//{
//  sendnano ="";
//  sendnano = "A" +String(biencanhbao)+"F";
//  Serial.print("sendnano: ");
//  Serial.println(sendnano);
//  mySerial.println(sendnano);
//  mySerial.flush();
//}
